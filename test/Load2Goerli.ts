...
const ARFLP = "0x04bfee1c089173805175f75437c2543a3bad49926d1c5dcfd5683b2759bf7692"
const ARFToken = "0x06d12ce4c0a9266b78e00a11c76597cf48caea36a57ae421ed38a0890496ae72"
...
describe("Deploy and initialize infrastrcture", function () {
    ...
    it("should initialize dependencies", async function () {
        ...
        await ctx.loadContracts([
            { name: "vault", src: "Vault", address: "0x03ce899d69993661ac2e07d64554f2fff4b7ea2be05f1a846cf63350d4f5da5d" },
        ])
        ...
        await ctx.execute("master", "vaultFactory", "initializeFund", {
            _vault: '0x03ce899d69993661ac2e07d64554f2fff4b7ea2be05f1a846cf63350d4f5da5d', _fundName: felt("myamazingfund"), _fundSymbol: felt("FND"), _denominationAsset: Eth, _positionLimitAmount: { low: 250n, high: 0 }, _amount: { low: 1000000000000000, high: 0 }, _shareAmount: { low: 10000000000000000000, high: 0 }, _feeConfig: [10, 10, 10, 10], _assetList: [Eth, BTC, ZKP, TST, Eth_ZKP, ETH_TST, ETH_BTC], _externalPositionList: [], _integration: [{ contract: ARFSwapControlleur, selector: swapExactTokensForTokens, integration: ARFSwap },
        ...
        //     _vault: ctx.vault.address, _contract: BTC, _selector: 949021990203918389843157787496164629863144228991510976554585288817234167820n, _callData: ["3",hexToDecimalString(ARFSwapControlleur), 1000000000000000000, 0]
        // })

        // await ctx.execute("master", "comptroller", "executeCall", {
        //     _vault: ctx.vault.address, _contract: Eth, _selector: 949021990203918389843157787496164629863144228991510976554585288817234167820n, _callData: ["3",hexToDecimalString(ARFSwapControlleur), 1000000000000000000, 0]
        // })

        // await ctx.execute("master", "comptroller", "executeCall", {
        //     _vault: ctx.vault.address, _contract: ARFSwapControlleur, _selector: hexToDecimalString("0x3f35dbce7a07ce455b128890d383c554afbc1b07cf7390a13e2d602a38c1a0a"), _callData: ["10",hexToDecimalString(Eth), hexToDecimalString(BTC), "0","0","0","0","0","0","0","0"]
        // })
