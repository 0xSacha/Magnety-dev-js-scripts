...
func init{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
    _comptrolleur : felt, _positionLimitAmount : Uint256
):
...
func onlyVaultComptrolleur{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}():
...
func __setComptrolleur{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
    _comptrolleur : felt
):
